// packages/convex-better-auth/src/solid/client/components/forms/Settings.tsx

/**
 * Settings Page Component for Solid
 ...
 * ```tsx
 * // In your route file:
 * import { Settings } from '@convex-better-auth/solid/client/forms'
 *
    ...
    <div class="min-h-screen w-full flex items-center justify-center p-4">
      <div class="w-full max-w-md">
        <SettingsContent
          ...
          showEmailVerification={props.showEmailVerification}
          showTwoFactor={props.showTwoFactor}
          showAccountDeletion={props.showAccountDeletion}
