/**
 * Composable for email/password sign-in in Solid
...
/**
 * Options for createSignIn composable
 */
export interface CreateSignInOptions {
...
/**
 * Composable for email/password authentication
 * Provides sign-in functionality with loading states and error handling
 *
 * @example
 * ```tsx
 * function SignInForm() {
 *   const { signInWithPassword, isLoading, error } = createSignIn({
 ...
 * ```
 */
export function createSignIn(options: CreateSignInOptions = {}) {
