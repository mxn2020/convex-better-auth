/**
 * Composable for magic link authentication in Solid
...
/**
 * Options for createMagicLink composable
 */
 ...
 *   const { sendMagicLink, isLoading, emailSent } = createMagicLink()
 *
 ...
 * ```
 */
export function createMagicLink(options: CreateMagicLinkOptions = {}) {
