/**
 * Composable for OTP (One-Time Password) authentication in Solid
...
/**
 * Options for createOTPAuth composable
 */
...
/**
 * Composable for OTP authentication
 ...
 * ```
 */
export function createOTPAuth(options: CreateOTPAuthOptions = {}) {
