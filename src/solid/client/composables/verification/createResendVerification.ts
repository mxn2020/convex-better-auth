/**
 * Composable for resending email verification in Solid
...
/**
 * Options for createResendVerification composable
 */
export interface CreateResendVerificationOptions {
...
/**
 * Composable for resending email verification
 ...
 *     >
 *       <Show when={canResend()} fallback={`Wait ${countdown()}s`}>
 *         Resend Verification
 *       </Show>
 *     </button>
 *   )
...
export function createResendVerification(
  options: CreateResendVerificationOptions = {}
) {
