/**
 * Composable for enabling two-factor authentication in Solid
...
/**
 * Options for createTwoFactorEnable composable
 */
export interface CreateTwoFactorEnableOptions {
...
/**
 * Composable for enabling two-factor authentication
 ...
 * ```
 */
export function createTwoFactorEnable(options: CreateTwoFactorEnableOptions = {}) {
