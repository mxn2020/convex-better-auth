// src/solid/client/composables/createPasswordReset.ts

/**
 * Composable for password reset flow
...
/**
 * Options for createPasswordReset composable
 */
 ...
 * ```
 */
export function createPasswordReset(options: CreatePasswordResetOptions = {}) {
