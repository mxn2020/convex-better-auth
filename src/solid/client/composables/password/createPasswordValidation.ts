// src/solid/client/composables/createPasswordValidation.ts

/**
 * Composable for password validation
 ...
 *
 *   const validation = createMemo(() => validate(password()))
...
export function createPasswordValidation(
  customRequirements?: Accessor<PasswordRequirements | undefined>
) {
